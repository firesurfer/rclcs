...
namespace rclcs
{
	...
	/// </summary>
	internal class rcl_publisher_windows : rcl_publisher_base
	{
		...
		public rcl_publisher_windows(Node _node, rosidl_message_type_support_t _type_support, string _topic_name, rcl_publisher_options_t _options) : base(_node, _type_support, _topic_name, _options)
		{
